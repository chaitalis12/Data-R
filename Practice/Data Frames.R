...
is.data.frame(stats[,2,drop=FALSE])
...
qplot(data=stats, x=Income.Group, y=Birth.rate, size=3, colour= "blue")
...
#--------------------------------------------merging dataframes
newdf <- merge(stats, mydf, by.x="Country.Code", by.y="codes")
newdf
head(newdf)
stats(newdf)

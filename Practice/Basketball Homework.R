...
FreeThrowAttemptPerGame <- FreeThrowsAttempts / Games
round(FreeThrowAttemptPerGame,1)
matplot(t(FreeThrowAttemptPerGame), type="b", pch=15:18, col=c(1:4,6))
legend("bottomleft",inset=0.01,legend=Players[], col=c(1:4,6), pch=15:18)
FreeThrowAttemptPerGame

Accuracy <-FreeThrows/Games
round(Accuracy,1)
matplot(t(Accuracy), type="b", pch=15:18, col=c(1:4,6))
legend("bottomleft",inset=0.01,legend=Players[], col=c(1:4,6), pch=15:18)
Accuracy

PlayersPlayingStyle<-(Points- FreeThrows)/ FieldGoals
round(PlayersPlayingStyle,1)
matplot(t(PlayersPlayingStyle), type="b", pch=15:18, col=c(1:4,6))
legend("bottomleft",inset=0.01,legend=Players[], col=c(1:4,6), pch=15:18)
PlayersPlayingStyle
